...
兩個世界的規則：深底頁 = 我的機房（講師操作，學員不用跟）；淺底頁 = 你的筆電（跟著做）。每次切換都有過場頁，講稿裡也會說「放下鍵盤」或「回到你的筆電」。
...
| 03–10 | 9–14 | 主張 + Cluster API 名詞頁 |
| 10–30 | 15–38 | demo① 插電上架（live）+ Tinkerbell 原理 + day-0 前六步 |
| 30–33 | — | 緩衝；確認全員 kind 已起來 |
| 33–53 | 39–58 | 第一幕：純 Cluster API（學員動手） |
| 53–62 | 59–71 | 過場對照 + day-0 後三步 + 收束三頁 |
| 62–82 | 72–96 | 第二幕：kro（學員動手）；70 分按 demo③ 扳機 |
