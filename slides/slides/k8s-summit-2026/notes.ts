...
export const nDemo1 = `講到這裡先來看真的東西。
...
export const nAct1Guide = `第一幕開始，接下來 20 分鐘你們自己動手。
...
export const nAct2Intro = `第二幕。右邊這 6 行就是一個完整的叢集定義。
...
export const nLineage = `這個原則叫 reconcile by replacement，壞了不修，直接換。
